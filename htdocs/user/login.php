...
class page_output
{
	...
	function execute()
	{
		...
		*/
		...
		// general
		$structure = NULL;
		$structure["fieldname"] 	= "username_mailguidance";
		$structure["type"]		= "input";
		$this->obj_form->add_input($structure);
		
		$structure = NULL;
		$structure["fieldname"] 	= "password_mailguidance";
	...
	function render_html()
	{
		...
		print "<p>Please enter your username and password to login to MailGuidance.</p>";
