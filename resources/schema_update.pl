...
#
# This script checks the current version of the database for the MailGuidance application
...
if ($help)
{
	print "MailGuidance Schema Management Utility\n";
	print "\n";
	print "Usage: schema_manage.pl --schemadir=<schemadir>\n";
	print "\n";
	print "-c, --cfgfile=FILENAME            MailGuidance configuration file with MySQL settings.\n";
	print "\n";
