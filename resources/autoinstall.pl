...
# for the MailGuidance application.
#
...
my $db_name		= "mailguidance";	# name of the DB to create
my $db_host		= "localhost";		# MySQL server

my $db_bs_user		= "mailguidance";	# name of the aoconf user to create
my $db_bs_password	= random_password(10);	# random password to generate

# location of config.php file
my $opt_cfgfile = "/etc/mailguidance/config.php";

# tmp file to use for SQL query generation
my $opt_tmpfile = "/tmp/mailguidance_mysqlquery";
...
print "\n";
print "This script setups the MailGuidance database components:\n";
print " * MailGuidance MySQL user\n";
print " * MailGuidance database\n";
print " * MailGuidance configuration files\n";
print " * Non-privillages mail user\n";
print "\n";
print "THIS SCRIPT ONLY NEEDS TO BE RUN FOR THE VERY FIRST INSTALL OF MAILGUIDANCE.\n";
